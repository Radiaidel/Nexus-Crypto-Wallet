...
<body class="bg-color">
    ...
    <nav class="bg-yellow-400 shadow dark:bg-gray-800 hidden" id="buypop">
        <div class="w-[95%] bg-white "><button class="float-right" id="closebuy"><svg xmlns="http://www.w3.org/2000/svg"
                    height="30" width="24" viewBox="0 0 384 512">
                    <path
                        d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" />
                </svg></button></div>
        <div
            class="container flex items-center justify-around w-[70%] p-8 mx-auto text-gray-600 capitalize dark:text-gray-300">
            ...
            <div class="flex flex-col items-center gap-5">
                ...
                <div class="flex justify-evenly ">
                    <button id="minqtn" class="mr-2 bg-gray-200 rounded-xl p-2"><svg xmlns="http://www.w3.org/2000/svg"
                            height="25" width="25" viewBox="0 0 448 512">
                            <path
                                d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" />
                        </svg></button>
                    <h2 id="qnt" class="text-3xl">1</h2>
                    <button id="addqtn" class="ml-2 bg-gray-200 rounded-xl p-2"><svg xmlns="http://www.w3.org/2000/svg"
                            height="25" width="25" viewBox="0 0 448 512">
                            <path
    ...
    <aside id="wallet"
        ...
        <section class="flex flex-col justify-center h-[50vh] w-[80%]bg-slate-800 text-gray-600 mt-8">
            ...
            <div>
                <div
                    class="flex flex-col col-span-full xl:col-span-8 bg-yellow-400 shadow-lg rounded-sm border border-gray-200 mb-2">
                ...
                <div
                    class="flex flex-col col-span-full xl:col-span-8 bg-yellow-400 shadow-lg rounded-sm border border-gray-200">
                    <header class="px-5 py-4 border-b border-gray-100 flex items-center">
                        <h2 class="font-semibold text-gray-800"></h2>
                    </header>
                    <div class="px-5 py-1">
    ...
    function addtofav() {
        ...
        for (let i = 0; i < fav.length; i++) {
            fav[i].addEventListener('click', e => {
                let id = cryptoid[i];
                let name = nametostore[i];

                var formData = new formData();
                formData.append('id', id);
                formData.append('crname', name);
                const xhr = new XMLHttpRequest();
                xhr.open('POST', '<?php echo URLROOT; ?>watchListController/addToWatchlist', true);
                xhr.onload = function () {
